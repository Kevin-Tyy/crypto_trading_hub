    ...
    <section class="w-full h-full px-8 py-4 flex flex-col gap-3">
        ...
        <div class="bg-[#1e1d26] h-full flex-1 rounded-3xl p-10">
            <div class="flex flex-col items-center justify-center mt-10">
                <div class="bg-gray-300 p-2 rounded-full w-40 h-40 grid place-content-center">
                    <div class="flex text-gray-800 text-5xl">
                        <span><%=user.getFirstName().charAt(0)%></span>
                        <span><%=user.getLastName().charAt(0)%></span>
                    </div>
                </div>
                <div class="flex gap-6 mt-5">
                    <h1 class="text-3xl"><%= user.getFirstName() %>
                    </h1>
                    <h1 class="text-3xl"><%= user.getLastName() %>
                    </h1>
                </div>
                <h4 class="text-gray-400 text-base mt-3"><%= user.getUsername() %>
                </h4>
            </div>
            <div class="flex justify-center mt-20">
                <div class="grid grid-cols-2 max-w-[1300px]  gap-y-16 mx-auto w-full">
                    <div class="space-y-2">
                        <h2 class="text-gray-300 flex items-center gap-x-2">
                        ...
                        <h1 class="text-xl"><%= user.getFirstName()%>
                        </h1>
                    </div>
                    <div class="space-y-2">
                        <h2 class="text-gray-300 flex items-center gap-x-2">
                        ...
                        <h1 class="text-xl"><%= user.getLastName()%>
                        </h1>
                    </div>
                    <div class="space-y-2 ">
                        <h2 class="text-gray-300 flex items-center gap-x-2">
                            <svg width="26px" height="26px" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M4 7.00005L10.2 11.65C11.2667 12.45 12.7333 12.45 13.8 11.65L20 7"
                                          stroke="#e5e5e5" stroke-width="2" stroke-linecap="round"
                                          stroke-linejoin="round"></path>
                                    <rect x="3" y="5" width="18" height="14" rx="2" stroke="#e5e5e5"
                                          stroke-width="2"
                        ...
                        <h1 class="text-xl"><%= user.getEmail()%>
                        </h1>
                    </div>
                    <div class="space-y-2">
                        <h2 class="text-gray-300 flex items-center gap-x-2">
                        ...
                        <h1 class="text-xl"><%= user.getPhoneNumber()%>
                        </h1>
                    </div>
                    <div class="space-y-2">
                        <h2 class="text-gray-300 flex items-center gap-x-2">
                        ...
                        <h1 class="text-xl"><%= user.getUsername()%>
                        </h1>
                    </div>
